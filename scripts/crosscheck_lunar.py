...
样本：
  ...
  * 四实体盘（游戏乙(示例)/游戏甲(示例)/回测样本/虚拟偶像甲(示例)）
  * 随机 300 盘 fuzz
...
CASES = [
    ...
    ("游戏乙(示例)", "2020-09-28 10:00", 8.0, 121.47, "auto"),
    ("游戏甲(示例)", "2024-05-23 10:00", 8.0, 113.3, "auto"),
    ("回测样本", "1989-12-13 08:36", -5.0, -75.93, "auto"),
    ("虚拟偶像甲(示例)", "2020-11-23 12:00", 8.0, 116.4, "auto"),
]
